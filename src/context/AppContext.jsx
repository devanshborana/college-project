...
const BASE_LEADERBOARD = [
  ...
  { rank: 4, name: 'Devansh Borana', id: 'LMCST-2024-001', basePoints: 2180, solved: 52, badges: 7,  color: '#3b82f6', isCurrentUser: true },
  { rank: 5, name: 'Kartik Bhatt',   id: 'LMCST-2024-059', basePoints: 1950, solved: 47, badges: 6,  color: '#22c55e' },
  { rank: 6, name: 'Sneha Patel',    id: 'LMCST-2024-023', basePoints: 1780, solved: 43, badges: 5,  color: '#ec4899' },
  { rank: 7, name: 'Vivek Joshi',    id: 'LMCST-2024-088', basePoints: 1640, solved: 39, badges: 5,  color: '#f97316' },
  { rank: 8, name: 'Meera Gupta',    id: 'LMCST-2024-014', basePoints: 1520, solved: 36, badges: 4,  color: '#14b8a6' },
  { rank: 9, name: 'Arjun Rathore',  id: 'LMCST-2024-065', basePoints: 1380, solved: 32, badges: 3,  color: '#6c47ff' },
  { rank: 10,name: 'Kavita Pareek',  id: 'LMCST-2024-038', basePoints: 1240, solved: 29, badges: 3,  color: '#ef4444' },
]
